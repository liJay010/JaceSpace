...
- **单 Reactor 单线程**
  ...
  ![单Reactor单进程](img\单Reactor单进程.png)
...
- **主从 Reactor 多线程**
  ...
  ![202203290943547](img\202203290943547.png)
...
<img src="img\202203290949372.png" />
...
<img src="https://cdn.jsdelivr.net/gh/luogou/cloudimg/data/202203221656865.png" />
...
<img src="https://cdn.jsdelivr.net/gh/luogou/cloudimg/data/20210824151934.png"/>

***socket* 其实就是操作系统提供给程序员操作「网络协议栈」的接口，说人话就是，你能通过*socket* 的接口，来控制协议找工作，从而实现网络通信**



## 15.C++网络通信中send和receive的为什么会阻塞

<img src="https://cdn.jsdelivr.net/gh/luogou/cloudimg/data/202203221702388.png" />
...
> epoll就是解耦了select的模型：
>
> <img src="img\202203231333124.png"  />
...
## 17.tcp 在调用connect失败后要不要重新socket？
...
<img src="img\202203231452388.webp"/>
...
- mmap/write 方式
  ...
  <img src="img\202203231457223.webp" />

  把数据读取到内核缓冲区后，应用程序进行写入操作时，直接把内核的`Read Buffer`的数据复制到`Socket Buffer`以便写入，这次内核之间的复制也是需要CPU的参与的。

- sendfile 方式

  <img src="https://cdn.jsdelivr.net/gh/luogou/cloudimg/data/202203231500195.webp"  />
...
- splice 方式
  ...
  <img src="https://cdn.jsdelivr.net/gh/luogou/cloudimg/data/202203231510067.png" />
...
<img src="img\202202282238507.png" />
...
## 25.使用epoll或select时需要将socket设为非阻塞吗？
...
## 28.pthread_cond_wait 为什么需要传递 mutex 参数？
...
- 错误写法
  ...
  <img src="https://cdn.jsdelivr.net/gh/luogou/cloudimg/data/202203181035470.jpeg"  />
...
<img src="img\952033-20200103182042686-2100862807.png"  />
