...
| ------------------------------------------------------------ | -------- | -------- | -------- | -------------- | -------- | ------------- | -------- | -------- | --------- | -------- | -------- |
| **yolov5x6u**                                                | **95.6** | **92.9** | **91.1** | **91.1**       | **98.4** | **94.2**      | 93.6     | 75.3     | **95.7**  | **91.0** | **91.8** |
...
| **layoutLmv3+单双栏区分+text特征部分融合（使用K融合）**      | 94.3     | 92.3     | 84.7     | 90.5           | 97.1     | 93.0          | 94.3     | 83.7     | 94.8      | 78.5     | 90.3     |
| **layoutLmv3+单双栏区分+text特征部分融合（使用CNN权重矩阵融合）** |          |          |          |                |          |               |          |          |           |          |          |
| **layoutLmv3+单双栏区分+文本特征在分类头池化层融合）**       |          |          |          |                |          |               |          |          |           |          |          |
